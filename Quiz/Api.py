...
def suggest_major(responses,data):
    ...
    response = openai.chat.completions.create(
      model="gpt-4o-mini",
        messages=[
            {"role": "system", "content": f"You are a helpful assistant that suggests majors and ranks them based on quiz responses. Make sure the majors that you give are strictly based ont the majors in {data}"},
